    ...
    init: function(a, o) {
      ...
      i.page = a, t = o, i.page.orderPay = function(a) {
          ...
          var r = a.currentTarget.dataset.index,
            n = i.page.data.order_list[r],
            d = new Array();
          if (void 0 !== i.page.data.pay_type_list) d = i.page.data.pay_type_list;
          else if (void 0 !== n.pay_type_list) d = n.pay_type_list;
          else if (void 0 !== n.goods_list[0].pay_type_list) d = n.goods_list[0].pay_type_list;
          else {
            var c = {};
            c.payment = 0, d.push(c);
          }
          var g = getCurrentPages(),
            u = g[g.length - 1].route,
            p = e.order.pay_data; -
        ...
        i.page.order_submit = function(o, s) {
          console.log(o.goods_info, "o是什么");
          console.log(JSON.parse(o.goods_info).goods_id);
          var goodsid = JSON.parse(o.goods_info).goods_id
              ...
              success: function(e) {
                ...
                if (0 == e.code) {
                  var r = function() {
                    t.request({
                      ...
                      success: function(e) {
                        ...
                        if (99 == e.code) {
                          wx.redirectTo({
                            url: '/pages/pay_status/pay_status?goodsid=' + goodsid + '&status=1'
                          })
                        }
                  ...
                  var n = e.data.order_id || "",
                    g = e.data.order_id_list ? JSON.stringify(e.data.order_id_list) : "",
                    u = "";
                      ...
                      if (0 != e.code) {
                          ...
                          complete: function(e) {
                            "requestPayment:fail" != e.errMsg && "requestPayment:fail cancel" != e.errMsg ? "requestPayment:ok" != e.errMsg || (void 0 !== i.page.data.goods_card_list && i.page.data.goods_card_list.length > 0 ? i.page.setData({
                              ...
                              success: function(e) {
                                e.confirm && wx.redirectTo({
                                  // url: c + "?status=0"
                                  url: '/pages/pay_status/pay_status?goodsid=' + goodsid + '&status=0'
                                });
                              }
                            });
                          }
                        ...
                        if (t) {
                          for (var o = t.length, r = 0; r < o; r++)
                            for (var d = t[r].goods, g = d.length, u = 0; u < g; u++) d[u].num = 0;
