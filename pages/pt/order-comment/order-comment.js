...
Page({
    ...
    setScore: function(t) {
        var o = this, i = t.currentTarget.dataset.index, a = t.currentTarget.dataset.score, e = o.data.goods_list;
        e[i].score = a, o.setData({
            goods_list: e
        });
    },
    contentInput: function(t) {
        var o = this, i = t.currentTarget.dataset.index;
        o.data.goods_list[i].content = t.detail.value, o.setData({
            goods_list: o.data.goods_list
        });
    },
    chooseImage: function(t) {
        var o = this, i = t.currentTarget.dataset.index, a = o.data.goods_list, e = a[i].pic_list.length;
        wx.chooseImage({
            count: 6 - e,
            success: function(t) {
                a[i].pic_list = a[i].pic_list.concat(t.tempFilePaths), o.setData({
                    goods_list: a
                });
            }
        });
    ...
    deleteImage: function(t) {
        var o = this, i = t.currentTarget.dataset.index, a = t.currentTarget.dataset.picIndex, e = o.data.goods_list;
        e[i].pic_list.splice(a, 1), o.setData({
            goods_list: e
        });
    },
    commentSubmit: function(i) {
        ...
        var n = s.data.goods_list, d = o.siteInfo, c = {};
